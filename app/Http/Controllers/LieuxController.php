...
class LieuxController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $lieux = Lieux::create([
            "enseigne" => $lieuValidation["enseigne"],
            "adresse" => $lieuValidation["adresse"],
            "description" => $lieuValidation["description"],
            "latitude" => $lieuValidation["latitude"],
            "longitude"=>$lieuValidation["longitude"],
        ]);
        return response($lieux, 201);
